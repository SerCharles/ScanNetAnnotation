"""
Revisiting Single Image Depth Estimation code gently borrowed from
https://github.com/JunjH/Revisiting_Single_Depth_Estimation/tree/master/models/modules.py
"""
