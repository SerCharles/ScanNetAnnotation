...
def loadClassMap():
    classMap = {}
    classLabelMap = {}
    with open(os.path.join(ROOT_FOLDER[:-6],  'scannetv2-labels.combined.tsv')) as info_file:
        line_index = 0
...
def readMesh(scene_id):
    ...
    filename = os.path.join(ROOT_FOLDER, scene_id, scene_id + '_vh_clean_2_selected.ply')
    ...
    filename = os.path.join(ROOT_FOLDER, scene_id, scene_id + '_vh_clean_2.0.010000_selected.segs.json')
